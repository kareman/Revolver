...
/// Implication node encapsulates logical implication carried out on two Boolean values.
public final class ImplicationNode: BinaryNode<Bool, Bool, Bool> {
     ...
     */
    public override func callInitializer(leftSide leftSide: ValueNode<Bool>, rightSide: ValueNode<Bool>) -> ImplicationNode {
